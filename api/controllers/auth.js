...
exports.getAuthUser = asyncHandler(async (req, res, next) => {
    console.log('getAuthUser controller req.user: ', req.user)
    const user = await User.findById(req.user.id)
        // .populate('resumes')
        // .populate('packages')
        // .populate('authorizations')
        ...
        .populate('authorizations')
        .populate('package')
    console.log('getAuthUser controller user: ', user)
    if (!user) {
...
exports.TOBEDELETED_getAuthResume2 = asyncHandler(async (req, res, next) => {
    console.log('getAuthResume controller req.resume1: ', req.resume1)
